...
/** @name Self-Test FIFO Variables
*
*   Variables used during the self-test function.
*
*
@{**/
volatile fifo_state_machine selftest_state_machine; /**< Structure for the self-test FIFO state machine */
volatile unsigned char selftest_fifo_buffer[256]; /**< Self-Test FIFO buffer */
/** @}*/
